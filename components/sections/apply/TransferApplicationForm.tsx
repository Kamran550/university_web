...
export default function TransferApplicationForm({
  ...
  const t = useTranslations("apply.transferForm");
  ...
  const baseSchema = {
    ...
    currentUniversity: z.string().min(1, t("required")),
    currentCourse: z.string().min(1, t("required")),
  };
  ...
  async function onSubmit(data: FormValues) {
    try {
      ...
      formData.append("current_university", data.currentUniversity);
      formData.append("current_course", data.currentCourse);
      ...
      const response = await fetch(`${backendUrl}/applications/transfer`, {
        method: "POST",
        body: formData,
      });
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("currentUniversity")} *</FormLabel>
                          <FormControl>
                            <Input {...field} />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("currentCourse")} *</FormLabel>
                          <Select
                            onValueChange={field.onChange}
                            defaultValue={field.value}
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={t("selectCurrentCourse")}
                                />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
